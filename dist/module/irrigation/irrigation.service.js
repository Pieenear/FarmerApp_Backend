...
// ==========================================
export const createLightScheduleService = async (data, adminId) => {
...
export const listLightSchedulesService = async (filters) => {
...
export const getLightScheduleByIdService = async (id) => {
...
export const updateLightScheduleService = async (id, data) => {
    const { areaId, dayOfWeek, startTime, endTime } = data;
...
export const deleteLightScheduleService = async (id) => {
    const existing = await prisma.lightSchedule.findUnique({
        where: { id },
    });
    if (!existing) {
...
// ==========================================
export const createMcbContactService = async (data) => {
...
export const listMcbContactsService = async (filters) => {
...
export const getMcbContactByIdService = async (id) => {
...
export const updateMcbContactService = async (id, data) => {
    const { areaId, contactName, designation, phoneNumber } = data;
...
export const deleteMcbContactService = async (id) => {
    const existing = await prisma.mcbContact.findUnique({
        where: { id },
    });
    if (!existing) {
