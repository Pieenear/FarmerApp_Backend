...
// ==========================================
export const createLightSchedule = async (req, res) => {
    try {
        if (!req.user) {
...
export const listLightSchedules = async (req, res) => {
    try {
        if (!req.user) {
            res.status(401).json({ error: "Unauthorized." });
            return;
...
export const getLightScheduleById = async (req, res) => {
    try {
        const { id } = req.params;
        if (typeof id !== "string") {
...
export const updateLightSchedule = async (req, res) => {
    try {
        const { id } = req.params;
        if (typeof id !== "string") {
            res.status(400).json({ error: "Invalid schedule ID format." });
...
export const deleteLightSchedule = async (req, res) => {
    try {
        const { id } = req.params;
        if (typeof id !== "string") {
            res.status(400).json({ error: "Invalid schedule ID format." });
...
// ==========================================
export const createMcbContact = async (req, res) => {
    try {
...
export const listMcbContacts = async (req, res) => {
    try {
        if (!req.user) {
            res.status(401).json({ error: "Unauthorized." });
            return;
...
export const getMcbContactById = async (req, res) => {
    try {
        const { id } = req.params;
        if (typeof id !== "string") {
...
export const updateMcbContact = async (req, res) => {
    try {
        const { id } = req.params;
        if (typeof id !== "string") {
            res.status(400).json({ error: "Invalid contact ID format." });
...
export const deleteMcbContact = async (req, res) => {
    try {
        const { id } = req.params;
        if (typeof id !== "string") {
            res.status(400).json({ error: "Invalid contact ID format." });
