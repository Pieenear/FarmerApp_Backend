...
router.patch("/logs/:id", authMiddleware, validateRequest(updateDetectionLogSchema), updateDetectionLog);
router.delete("/logs/:id", authMiddleware, deleteDetectionLog);
