...
// ==========================================
export const createGroupService = async (data, requesterId) => {
...
export const listGroupsService = async (filters) => {
    const where = { status: GroupStatus.active };
    if (filters.areaId) {
...
export const joinGroupService = async (groupId, farmerId) => {
...
export const leaveGroupService = async (groupId, farmerId) => {
...
export const listGroupMembersService = async (groupId) => {
    const group = await prisma.farmerGroup.findUnique({
        where: { id: groupId },
    });
    if (!group) {
...
export const deleteGroupService = async (groupId, requesterId) => {
    const requester = await prisma.user.findUnique({
        where: { id: requesterId },
    });
    if (!requester) {
