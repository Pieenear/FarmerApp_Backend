 ...
 */
export const uploadReportService = async (data, adminId) => {
 ...
 */
export const addSimplifiedReportService = async (labReportId, data) => {
    ...
    return await prisma.simplifiedReport.upsert({
        ...
        create: {
            ...
            keyParameters: keyParameters ? keyParameters : Prisma.DbNull,
 ...
 */
export const getReportListService = async (userId, userRole) => {
 ...
 */
export const getReportByIdService = async (id, userId, userRole) => {
