import { uploadReportService, addSimplifiedReportService, getReportListService, getReportByIdService, } from "./report.service.js";
 ...
 * @access  Private (Admin)
 */
export const addSimplifiedReport = async (req, res) => {
    try {
        const { id } = req.params;
        if (typeof id !== "string") {
