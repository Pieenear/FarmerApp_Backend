...
export const createBuyerService = async (data: CreateBuyerInput, adminId: bigint) => {
...
export const listBuyersService = async (filters: { isActive?: boolean; areaId?: bigint }) => {
...
export const getBuyerByIdService = async (id: bigint) => {
...
export const updateBuyerService = async (id: bigint, data: UpdateBuyerInput) => {
  const { name, phone, companyName, gstNo, preferredCrops, areaId } = data;
...
export const deleteBuyerService = async (id: bigint) => {
  const existing = await prisma.buyer.findUnique({ where: { id } });
  if (!existing) {
    throw new Error("Buyer not found.");
  }
...
export const listCropListingsService = async (
  role: Role,
  userId: bigint,
  filters: { status?: ListingStatus; cropType?: string }
) => {
...
export const getCropListingByIdService = async (id: bigint, role: Role, userId: bigint) => {
...
export const updateCropListingService = async (id: bigint, data: UpdateListingInput) => {
...
export const createBuyerMatchService = async (data: CreateMatchInput, adminId: bigint) => {
